...
Command line application tool for data download
...
def cli_parser() -> argparse.ArgumentParser :
    ...
    parser = argparse.ArgumentParser(
        prog='CLI-DOWNLOAD',
        description=f'A simple app to aid download of data from remote sources',
        epilog='  ---  ',
...
def cli_parse_args(argv=None) -> argparse.Namespace:
    """
    Function to parse the passed arguments into an argparse namspace object
    :param argv:
