"""Test the cli canned_data analysis tool."""
...
# Define cli filepath
CLI = Path(SRC_DIR, PACKAGE, "cli_canned_data.py")
# No docstring, to avoid publishing system filepaths
MODULE = "cmatools.cli_canned_data"
"""str: Module name."""
TOOL = "cli-canned"
"""str: Script command name."""

# Testing note
# cli_canned_data tool is registered via entry points
...
# TODO - also test via calls to entrypoint function in cli_canned_data  ?
